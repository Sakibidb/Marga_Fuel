        ...
        <div class="main-content-inner">
            <div class="page-content">
                <div class="page-header">
                    <h4 class="page-title"><i class="fa fa-list"></i> Shift Edit</h4>
                </div>
                @if ($errors->any())
                ...
                <div class="mt-2">
                    <div class="mt-2 ">
                        <div class="row">
                            <div class="col-12">
                                <form class="form-horizontal mt-2" action="{{ route('shift.update', $shift->id) }}"
                                            ...
                                            <div class="form-group mb-1">
                                                <div class="input-group width-100">
                                                    ...
                                                    <input type="time" class="form-control" name="stime"
                                                        id="etime" value="{{ $shift->stime }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group mb-1">
                                                <div class="input-group width-100">
                                                    ...
                                                    <input type="time" class="form-control" name="etime"
                                                        id="etime" value="{{ $shift->etime }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
