                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                ...
                                <form id="product-purchase-form" class="form-horizontal product-purchase-form"
                                    action="{{ route('adjustment.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-md-12 col-md-offset-4">
                                            ...
                                            <div id="product_list">
                                                ...
                                                @foreach ($products as $product)
                                                  <div class="product-item" data-product-id="{{ $product->id }}" data-stock="{{ $product->stock }}">
                                                    {{ $product->name }}
                                                  </div>
                                                @endforeach
                                              </div>
                                        ...
                                        document.addEventListener("DOMContentLoaded", function() {
                                          ...
                                          Array.from(productList).forEach(function(product) {
                                            product.addEventListener('click', function() {
                                              ...
                                              const currentStock = selectedProduct.stock; // Assuming current_stock is a field in your product model
                                              ...
                                              <tr>
                                                ...
                                                <td><input type="text" name="current_stock[${productId}]" class="form-control current-stock" value="${currentStock}" readonly></td>
                                                <td class="text-center">
                                                  <select name="adjustment_type[${productId}]" class="form-control" required>
                                                    <option value="increase">Increase</option>
                                                    <option value="decrease">Decrease</option>
                                                  </select>
                                                </td>
                                                <td class="text-center">
                                                  <select name="reason[${productId}]" class="form-control" required>
                                        ...
                                        const searchBox = document.getElementById('product_search');
                                            ...
                                            Array.from(productList).forEach(function(product) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input type="number" name="quantity[]" class="form-control quantity" value="1" required></td>
                                                    <td class="text-center total-price">0.00</td>
                                                        <td><input type="text" name="current_stock[${productId}]" class="form-control current-stock" readonly></td>
                                                        <td class="text-center">
                                                            <select name="adjustment_type[${productId}]" class="form-control" required>
                                                                <option value="increase">Increase</option>
                                                                <option value="decrease">Decrease</option>
                                                ...
                                                <table class="table table-bordered fixed-table-header" id="purchaseTable">
                                                    <thead>
                                                        <tr class="table-header-bg">
                                                            ...
                                                            <th width="10%" class="text-center">Adjustment Type</th>
