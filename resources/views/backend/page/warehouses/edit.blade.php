    ...
    <div class="main-content-inner">
        <div class="page-content">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <h4 class="pl-2">Edit Warehouse</h4>
            </div>
                ...
                <div class="col-12">
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal mt-2" action="{{ route('warehouses.update', $warehouse->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-lg-5" style="margin-left: 80px">
                                        <div class="form-group mb-1">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" value="{{ $warehouse->name }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-1">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="text" class="form-control" name="location" id="location" value="{{ $warehouse->location }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-1">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="number" class="form-control" name="capacity" id="capacity" value="{{ $warehouse->capacity }}" required>
                                            </div>
                                        </div>
